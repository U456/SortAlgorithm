        ...
        //插入IC卡表信息
        public int insertEntity(String card_id,String seat_id,String user_name,String user_addr,String car_num)
        {
            String sqlCmd="Insert into Card values('" + card_id + "','" + seat_id + "','" + user_name + "','" + user_addr + "','"+car_num+"')";
            return SQLUtil.executeNonQuery(sqlCmd, null);
        }
